...
class SyncService:
    ...
    def sync_monthly_games(self, username: str, year: int, month: int):
        self._validate_monthly_args(username, year, month)
    ...
    def sync_time_control_games(self, username: str, basetime: int, increment: int):
        self._validate_time_control_args(username, basetime, increment)
    ...
    def _validate_monthly_args(self, username: str, year: int, month: int) -> None:
    ...
    def _validate_time_control_args(self, username: str, basetime: int, increment: int) -> None:
        self._validate_username(username)
        if basetime <= 0:
